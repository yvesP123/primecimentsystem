...
%>
							...
							<a href="edit-client.jsp?id=<%=rs.getString("id") %>" class="btn btn-transparent btn-xs" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-pencil"></i></a>
													
	<a href="delete.jsp?id=<%=rs.getString("id") %>" onClick="return confirm('Are you sure you want to delete?')"class="btn btn-transparent btn-xs tooltips"data-toggle="tooltip" data-original-title="Delete"><i class="fa fa-times fa fa-white"></i></a>
