...
<html lang="en">
	<head>
		<title>Accountant | add Product</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Accountant | Add Product</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												...
												<div class="panel-body">
													...
													<form role="form" name="adddoc" method="post" action="product-process.jsp">
...
<div class="form-group">
					...
					<input type="text" name="quantity" class="form-control"  placeholder="Enter Quantity Eg:100(kg)" required="true">
														</div>
