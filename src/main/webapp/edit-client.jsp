										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												...
												%>
													...
													<form role="form" name="adddoc" method="post" action="update-process.jsp">
...
<input type="text" id="docemail" name="quantity" class="form-control" value="<%=rs.getString("quantity")%>">
...
<div class="form-group">
					...
					<input type="text" name="unit" class="form-control"  value="<%=rs.getString("unit")%>">
														</div>
					...
					<input type="text" name="idnumber" class="form-control"  value="<%=rs.getString("idnumber")%>">
														</div>
