...
<html lang="en">
	<head>
		<title>Prime|ManageProduct</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Accountant | Manage Product</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
						...
						<div class="container-fluid container-fullw bg-white">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Manage <span class="text-bold">Product</span></h5>
									<p style="color:red;"></p>	
...
%>
											...
											<tr>
												...
												<td><%=rs.getString("quantity") %>Kg</td>
												<td class="hidden-xs"><%=rs.getString("dates") %></td>
											...
											<%} %>
											<tr>
											<td>Total Quantity:<% out.print(a); %>Kg</td>
											</tr>
