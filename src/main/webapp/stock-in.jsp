				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Accountant | Stock In</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
						...
						<div class="container-fluid container-fullw bg-white">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Stock <span class="text-bold">In</span></h5>
									<p style="color:red;"></p>	
									<table class="table table-hover" id="sample-table-1">
										...
										<thead>
											<tr>
												...
												<th class="hidden-xs">Avaliable Quantity</th>
